...
void VSimTop::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/gaoyukang/Projects/chisel-counter/build/SimTop.v", 67, "",
...
VL_INLINE_OPT void VSimTop::_sequent__TOP__1(VSimTop__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSimTop::_sequent__TOP__1\n"); );
    VSimTop* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->SimTop__DOT__myCounter__DOT__c = ((IData)(vlTOPp->reset)
                                               ? 0U
                                               : ((0x10U 
                                                   == vlTOPp->SimTop__DOT__myCounter__DOT__c)
                                                   ? 0U
                                                   : vlTOPp->SimTop__DOT__myCounter__DOT___c_T_1));
