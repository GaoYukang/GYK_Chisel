...
void VSimTop::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgBit(oldp+2,(vlTOPp->io_tick));
        tracep->chgBit(oldp+3,((0x10U == vlTOPp->SimTop__DOT__myCounter__DOT__c)));
        tracep->chgIData(oldp+4,(vlTOPp->SimTop__DOT__myCounter__DOT__c),32);
    }
}
